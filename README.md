...
Created with love by: `Edward, Hang and Khoa`
  
View online at: `https://admiring-montalcini-a9ff4e.netlify.com/`
...
* [x] When a "Liked" tweet is retweeted, the new tweet should not be liked. // maybe later 
...
* [x] Retweet has new timestamp

* [] If a tweet is too long then we style the text in the input box and make background character red
